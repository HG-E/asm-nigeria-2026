...
Phase 3 (Admin) is next: conference/subtheme management, and — most importantly — a way to add the 5 real reviewers once their names are supplied, since nothing in Phase 4 (review workflow) can be meaningfully tested without them.
