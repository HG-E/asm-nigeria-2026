...
export const ATTENDANCE_MODES = ["Virtual", "In-person", "Both"] as const
...
export const registrationSchema = z.object({
  ...
  attendanceMode: z.enum(ATTENDANCE_MODES, { error: "Select whether you'll attend virtually or in-person." }),
