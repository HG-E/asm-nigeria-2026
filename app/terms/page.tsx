...
export const metadata = {
  ...
  description: "Terms, declarations, and fee policy for abstract submission and registration at the Maiden American Society for Microbiology Nigeria Conference 2026.",
